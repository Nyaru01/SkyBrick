...
export default function Dashboard() {
    ...
    const [virtualScreen, setVirtualScreen] = useState('breakout');
    ...
    const isVirtualGameActive = effectiveTab === 'virtual' && (!!virtualGameState || onlineGameStarted || (virtualScreen === 'breakout' && isBreakoutPlaying));
                ...
                if (gameStatus === 'SETUP') {
                    return (
                        <motion.div
                            ...
                            className="flex flex-col pt-2 pb-6"
                        >
                            <GameSetup
                            ...
                            <CardHeader>
                                <CardTitle className="flex items-center justify-between text-slate-900 dark:text-slate-100">
                                    <div className="flex items-center gap-2">
                                        <Sparkles className="h-5 w-5 text-emerald-600 dark:text-emerald-400" /> SkyBrick Hub
                                    </div>
                                    <button
