...
export function Toast({ notification, onDismiss }) {
    ...
    const colors = {
        ...
        success: 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/50 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800',
        warning: 'bg-amber-100 text-amber-800 dark:bg-amber-900/50 dark:text-amber-300 border-amber-200 dark:border-amber-800',
        error: 'bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 border-red-200 dark:border-red-800',
        achievement: 'bg-slate-900 text-cyan-400 border-cyan-500/50 shadow-[0_0_20px_rgba(34,211,238,0.3)]'
    };
